...
public class DecreaseTool extends Tool {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        String itemName = showOptionPane("Which item do you want to decrease? Enter its name:");
        if (doNotContinue("itemName", itemName)) {
            return;
        }

        String decreaseQuantityStr = showOptionPane("By how many?");
        if (doNotContinue("itemQuantity", decreaseQuantityStr)) {
            return;
        }
